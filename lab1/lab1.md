...
```
git clone https://github.com/upenn-acg/cis501.git
```
...
Once your code passes all the tests and the demo works as expected, you are ready to submit it **via Canvas**. 
