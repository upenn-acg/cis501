...
iverilog.exe -g2012 -W all -I include -D GENERATE_VCD=1 -DINPUT_FILE=\"test_data/%1.ctrace\" -DOUTPUT_FILE=\"test_data/%1.output\" -DMEMORY_IMAGE_FILE=\"test_data/%1.hex\" -DVCD_FILE=\"%1.vcd\" -o %1.out include\clock_util.v include\register.v include\bram.v include\delay_eight_cycles.v include\lc4_memory.v lc4_pipeline.v testbench_lc4_processor.v lc4_alu.v lc4_cla.v lc4_decoder.v lc4_divider.v lc4_regfile.v
vvp.exe %1.out
